...
if (isset($_SESSION['login'])) {
    $mem_id = $pdo->query("select `id` from `members` `acc`='{$_SESSION['login']}'")->fetchColumn();
...
$sql = "insert into `logs`(`mem_id`,`topic_id`,`vote_time`,`records`) values ('$mem_id','$topic_id','$vote_time','$records')";
$pdo->exec($sql);
